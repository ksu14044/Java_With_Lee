...
class OrderService {
    ...
    //OrderService 생성자 : 결제 처리기와 보고서 생성기를 주입받는다.
    ...
    void placeOrder(Order order) {
        ...
        System.out.println("Order processed seccessfully"); // 주문 처리 완료 메시지 출력
    }
}
...
public class C_OOP {
    public static void main(String[] args) {
        ...
        //PaypalPaymentProcessor를 결제 처리기로 선택
        PaymentProcessor paymentProcessor1 = new PaypalPaymentProcessor() ;
        ...
        OrderService orderService1 = new OrderService(paymentProcessor1, generateReport);

        Order order1 = new Order("1", 18000);
        Order order2 = new Order("2", 22000);
        Order order3 = new Order("3", 15000);
        Order order4 = new Order("4", 12000);
