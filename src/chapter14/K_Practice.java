...
public class K_Practice {
    public static void main(String[] args) {
        List<String> fileNames = Arrays.asList(
                "document.pdf", "image1.png", "video.mp4", "presentation.ppt", "image2.png", "image3.jpg"
                , "image4.png", "javascript.js"
        );

        // 1. 특정 확장자(.png, .jpg) 필터링
        // List<String>
        List<String> containJpg = fileNames.stream()
                .filter(string -> string.contains(".jpg"))
                .collect(Collectors.toList());
        System.out.println(containJpg);

        List<String> containPng = fileNames.stream()
                .filter(string -> string.contains(".png"))
                .collect(Collectors.toList());
        System.out.println(containPng);
