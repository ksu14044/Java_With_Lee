        ...
        while(true) {
            ...
            switch(choice) {
                ...
                case 3: // 단건 책 조회 : 요청 데이터 O, 반환 데이터 O
                    ...
                    if (findBookId != -1) {
                        Book findBook = service.findBookById(findBookId);
                        view.displayBook(findBook);
                    } else {
                ...
                case 4: // 책 수정 : 요청 데이터 O, 반환 데이터 X
                    ...
                    if( modifiedId != -1) {
                        Book uppdatedBook = view.getBookDetails();
                        if(uppdatedBook != null) {
                            service.updateBook(modifiedId, uppdatedBook);
                        } else {
