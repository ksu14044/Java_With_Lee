...
// cf) 보일러플레이트 코드 : 프로그램에서 반복되는 작업이나 패턴에 대한 일종의 표준화된 코드
    ...
    /*LombokClass(String title){
      ...
      /*  public static class Builder {
        ...
        public static void main(String[] args) {
            LombokClass lombokClass1 = new LombokClass("HelloLSA", "LSA");
            // final 변수값 - 재할당 불가
            ...
            LombokClass lombokClass2 = new LombokClass("MerongLDK", "LDK");
            ...
            System.out.println(lombokClass3.getTitle());
