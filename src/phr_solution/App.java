...
public class App {
    ...
    public static void main(String[] args) {
        try {
            while(true) {
                ...
                // 사용자의 선택을 처리 (처리의 반환 값이 false 면 while 문 종료)
    ...
    private static void displayMenu() {
        ...
        System.out.println("3. 환자 정보 단권 조회");
    ...
    private static boolean processChoice(int choice) {
        switch (choice) {
            ...
            case 5: { // 환자 정보 삭제 : 환자 고유 번호
                ...
                System.out.println("환자가 삭제되었습니다.");
                break;
            }
            // 건강 기록 관련 기능
            case 6: { // 건강 기록 추가 : 환자 고유 번호, 방문 날짜, 진단명, 처방
            ...
            case 9: { // 건강 기록 삭제 : 건강 기록 고유 번호
                ...
                System.out.println("건강기록이 삭제되었습니다.");
                break;
            }
            case 10: {
