...
// - 메서드명, 매개변수 일치, 반환타입은 없거나 자동 형 변환 가능하게 작성
// - 메서드 위에 @Override 어노케이션을 작성

// 3. 오버라이딩 사용 목적
// - 다형성 구현
//      : 하나의 이름으로 여러 가능을 수행하는 코드 작성
// - 재사용성, 확장성 향상
...
public class Overriding {
    public static void main(String[] args) {
        ...
        // : 해당 상태나 동작을 반드시 가지지만 상속받는 클래스 마다 차이를 두고 싶을 때 사용
        ...
        // : 메서드명은 동일
        // : 매개변수의 타입, 갯수, 순서 중 적어도 하나 이상은 달라야 함
        // > 반환타입은 관련이 X
