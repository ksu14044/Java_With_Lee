...
//      +) 클래스명은 파일 이름과 동일해야 함. (대소문자까지 모두)
// - 메인 메서드(main)을 포함하여 프로그램의 시작 지점을 제공
public class StudentManagementApp {
    ...
    // - 'main' : JVM이 프로그램 실행 시 가장 먼저 찾는 메서드 이름 - 반드시 main
    //          +) 대소문자를 구분하기 떄문에 'main'로 작성
    ...
    public static void main(String[] args) {
        ...
        updateStudentGpa(3, 2.6);
        updateStudentGpa(4, 2.7);
